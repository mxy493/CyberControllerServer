...
class ScreenCapture:
    ...
    def start(self):
        ...
        self.top = tkinter.Toplevel(
            self.root, width=screenWidth, height=screenHeight)
        ...
        self.canvas.create_image(
            screenWidth//2, screenHeight//2, image=self.p_w_picpath)
        ...
        def onLeftButtonMove(event):
            ...
            lastDraw = self.canvas.create_rectangle(
                self.X.get(), self.Y.get(), event.x, event.y, outline='red', width=8)
